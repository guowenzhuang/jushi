package com.jushi.oss.pojo.consts;
...
public class OssConst {
    ...
    public static String SPRING_OSS_BUCKET_NAME="jushi-oss";
    public static String PATH_PREFIX="http://jushi-oss.oss-cn-beijing.aliyuncs.com/";
}
